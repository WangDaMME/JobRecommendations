...
public class Item {
    ...
    private String id; // 没必要 是 public
    private String title;
    private String location;
    private String companyLogo;
    private String url;
    private String description;
    private Set<String> keywords;  // 不是从github api 来的，以后自己extract
    // list order的，原因 1 dedup 2 keywords 认为没有order
    private boolean favorite;  // 标记 喜不喜欢
    ...
    public void setFavorite(boolean favorite)
   {
    ...
    // Most Data Entity model class need Override equals()/hashcode(),toString() sad
    ...
    // 解决 Argument 太多 位置放反了
    // return this--> return 一个 builder 对象 chain 来 连接
    ...
    public static class Builder
    {
        ...
        // Item item = new item.Builder(); // call了 builder class 的constructor
    }
}
